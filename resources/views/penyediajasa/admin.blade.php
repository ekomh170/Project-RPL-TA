                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    @foreach ($allPekerja as $pekerja)
                                        <tr>
                                            <td>{{ $pekerja->nama }}</td>
                                            <td>{{ $pekerja->email }}</td>
                                            <td>{{ $pekerja->telpon }}</td>
                                            <td><a href="{{ route('detail-penyediajasa', $pekerja->id) }}" >
                                                DETAIL
                                            </a></td>
                                        </tr>
                                    @endforeach
